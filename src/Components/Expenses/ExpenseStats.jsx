...
// const ExpenseStats = () => {
//   const [chartData, setChartData] = useState(null);
//   const [chartType, setChartType] = useState("bar"); // Default is Bar Chart
//   const [timeRange, setTimeRange] = useState("1m");
...
//       setChartData({
//         labels: Object.keys(categoryData), // Expense Categories
//         datasets: [
//           {
//             label: `Expenses (${timeRange === '1m' ? 'Last 1 Month' : timeRange === '6m' ? 'Last 6 Months' : 'Last 1 Year'})`,
//             data: Object.values(categoryData), // Expense Values
//             backgroundColor: [
//               "rgb(251, 29, 77)", // Red
//               "rgb(36, 129, 192)", // Blue (Salary)
//               "rgb(199, 145, 8)", // Yellow
//               "rgb(60, 152, 152)", // Teal
//               "rgb(139, 84, 249)", // Purple
//               "rgb(237, 149, 61)", // Orange
//             ],
//             borderColor: [
//               "rgb(251, 29, 77)",
//               "rgb(36, 129, 192)",
...
//                   plugins: {
//                     legend: {
//                       position: "right", // Legends on right
//                       labels: {
//                         boxWidth: 20, // Make color boxes smaller
//                       },
//                     },
//                   },
...
//                       },
//                     },
//                   } : {}, // Apply rotation only for bar chart
//                 }}
//               />
//             ) : (
//               <p>Loading chart...</p>
...
const ExpenseStats = () => {
  ...
  const fetchChartData = async () => {
    try {
      let url = `expense/expense_category_summary/?`;
      if (timeRange) {
      ...
      setChartData({
        ...
        datasets: [
          {
            label: timeRange
              ? `Expenses Summary for ${timeRange === "6m" ? "Last 6 Months" : "Last 1 Year"}`
              : `Expenses Summary for ${new Date(year, month - 1).toLocaleString("default", { month: "long" })} ${year}`,
            data: Object.values(categoryData),
            backgroundColor: [
