...
//   return await axios.post(`${base_url}/authentication/register/`, data);  // Corrected URL to include '/register/'
// };
...
// //     } catch (error) {
// //       throw error.response ? error.response.data : 'Something went wrong'; // Handle errors
// //     }
// //   };
...
// //     try {
// //       const response = await axios.post(`${base_url}/authentication/logout/`);
// //       return response.data; // Return success message from response
// //     } catch (error) {
// //       throw error.response ? error.response.data : 'Something went wrong'; // Handle errors
// //     }
...
// // Request Reset Email API function
...
//     try {
//         const response = await axios.get(`${base_url}/expense/categories/`, { headers });
//         return response.data;
//     } catch (error) {
//         throw error.response ? error.response.data : 'Something went wrong';
//     }
...
//     try {
//         const response = await axios.post(`${base_url}/expense/expenses/`, data, { headers });
//         return response.data;
//     } catch (error) {
//         throw error.response ? error.response.data : 'Something went wrong';
//     }
